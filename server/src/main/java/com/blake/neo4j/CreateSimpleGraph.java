...
{  
    private static final String SERVER_ROOT_URI = "http://192.168.185.59:7474/db/data/";  
    ...
    {  
        ...
        URI firstNode = createNode("Joe Strummer");  
        addProperty( firstNode, "name", "Joe Strummer" );  
        URI secondNode = createNode("The Clash");  
    ...
    private static URI createNode(String string)  
    {  
...
//        resource.addFilter(new HTTPBasicAuthFilter("neo4j", "000000"));
